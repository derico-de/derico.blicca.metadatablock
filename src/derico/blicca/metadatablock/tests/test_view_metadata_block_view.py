"""Tests for MetadataBlockView view."""
import pytest
...
class TestViewMetadataBlockView:
    """Test MetadataBlockView view."""
    ...
    def test_view_name(self):
        ...
        assert view.__name__ == "aurora-block-metadata"
